...
model = model.cuda()
# TODO change to graph mode to increase performance pytorch profiler (chrome tracer)
# =============================================================================
# Optimizer
# =============================================================================
...
# TODO update ips calculation
ips = (n_iteration * batch_size) / tot_time
print(f"ELAPSED TIME = {tot_time}s, THROUGHPUT = {ips} samples/s")
