...
def init_processes(local_world_size, local_rank, epochs):
    ...
    train(local_rank, local_world_size, epochs)
...
if __name__ == "__main__":
    ...
    init_processes(args.local_world_size, args.local_rank, args.epochs)
